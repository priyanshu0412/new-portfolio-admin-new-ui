        ...
        <>
            <div className="flex flex-col w-full min-h-screen h-full">
                ...
                <div className="flex flex-col items-start gap-y-6 w-full justify-between">
                    ...
                    <ReUseHeadingTitle
                        title={"Add Your Footer"}
                        desc={"Add your Footer here and manage all your versions in one place."}
                    />
                </div>
...
export default CreateFooterForm;
