...
const CreateTemplateCategoryForm = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (res.success) {
                toast.success("Template Category added successfully!");
                setTimeout(() => {
        ...
        <>
            <div className="flex flex-col w-full min-h-screen h-full">
                ...
                <div className="flex flex-col items-start gap-y-6 w-full justify-between">
                    ...
                    <ReUseHeadingTitle
                        title={"Add Your Template Category"}
                        desc={"Add your Template Category here and manage all your categories in one place."}
                    />
                </div>
                ...
                <div className="mt-8 w-full bg-white border border-gray-200 rounded-xl shadow-md p-6 overflow-hidden">
                    ...
                    >
                        ...
                        <div className="flex gap-x-4 mt-4">
                            ...
                            >
                                {loading ? "Uploading..." : "Add Template Category"}
                            </button>
...
export default CreateTemplateCategoryForm
